...
const serviceCards = [
  { title: 'Закупки и сопровождение', description: 'Поиск товаров, выкуп, работа с Taobao, 1688, Alibaba, переговоры с фабриками, устный и письменный перевод.', image: procurementImg },
  ...
  { title: 'Склад и погрузка', description: 'Аренда складов, консолидация грузов, фулфилмент, услуги грузчиков, погрузка контейнеров и спецтехника.', image: warehouseImg },
  { title: 'Упаковка и маркировка', description: 'Упаковка для логистики и маркетплейсов, маркировка, прессование, обрешётка и спецподготовка.', image: packagingImg },
  { title: 'Дополнительные услуги', description: 'Сопровождение на выставках, private label, представительство в Китае и решение нестандартных задач.', image: communicationsImg },
];
