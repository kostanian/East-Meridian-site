...
const faqs = [
  ...
  },
  {
    ...
    a: 'Мы переводим средства поставщику в юанях через такие каналы оплаты как: WeChat, Alipay, банковский перевод, встроенные платежные шлюзы на интернет площадках.',
  },
  {
