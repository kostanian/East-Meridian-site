...
export const serviceCategories: ServiceCategory[] = [
  {
    slug: 'procurement',
    title: 'Закупки и сопровождение',
    shortTitle: 'Закупки',
    description: 'Полный цикл закупок в Китае — от поиска товара до переговоров, с переводческим сопровождением.',
    heroDescription: 'Мы берём на себя весь процесс закупок: поиск товаров и поставщиков, выкуп, работа с площадками, переговоры с фабриками и переводческие услуги.',
    icon: ShoppingCart,
    services: [
  ...
  {
    slug: 'warehouse-loading',
    title: 'Склад и погрузка',
    shortTitle: 'Склад',
    description: 'Аренда склада, консолидация грузов, фулфилмент, погрузка контейнеров и спецтехника.',
    heroDescription: 'Складские услуги и погрузочные работы: аренда пространства, консолидация, фулфилмент, услуги грузчиков и спецтехники.',
    icon: Warehouse,
    services: [
  ...
  },
  {
    ...
    heroDescription: 'Упаковка под международную логистику и маркетплейсы. Маркировка, прессование, обрешётка и специальные конструкции для защиты груза.',
    icon: Package,
    services: [
